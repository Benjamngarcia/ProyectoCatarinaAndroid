...
public class Adapter extends ArrayAdapter<Usuarios> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvRes = view.findViewById(R.id.txt_result);
        TextView tvName = view.findViewById(R.id.txt_name);

        tvID.setText(arrayUsuarios.get(position).getMatricula());
        tvRes.setText(arrayUsuarios.get(position).getResult());
